...
<body>
    <?php
        ...
        if (isset($_GET['valtOrd'])) {
            ...
            // ! gör att den kollar om påståendet INTE är sant, dvs samma sak som: if (in_array($word, $svenska) == false)
            if (!in_array($word, $svenska)) {
                echo ("Du angav ett ord som jag inte kan översätta. <br><br><a href=\"oversattare_formular.htm\">Försök igen.</a>");
